  ...
  return (
    <Card className="overflow-hidden">
      ...
      <div className="divide-y">
        ...
        <div className="p-3 flex items-center justify-between hover:bg-accent/50 transition-colors cursor-pointer">
          <div className="flex items-center gap-2">
            <div className="flex items-center justify-center size-8 rounded-full bg-primary/10">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Add an authorised contact</p>
            </div>
          </div>
          <Button variant="ghost" size="icon" className="size-7">
